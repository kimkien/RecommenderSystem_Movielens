...
def get_model(num_users, num_items, mf_dim=10, layers=[10], reg_layers=[0], reg_mf=0):
    ...
    user_vec_mlp = keras.layers.Flatten(name='FlattenUsers-MLP')(keras.layers.Embedding(num_users, int(layers[0]/2), name='User-Embedding-MLP')(user_input))
    user_vec_mlp = keras.layers.Dropout(0.2)(user_vec_mlp)

    user_vec_mf = keras.layers.Flatten(name='FlattenUsers-MF')(keras.layers.Embedding(num_users, mf_dim, name='User-Embedding-MF')(user_input))
    user_vec_mf = keras.layers.Dropout(0.2)(user_vec_mf)

    concat = keras.layers.merge.concatenate([movie_vec_mlp, user_vec_mlp], name="Concat")
    mlp_vector = keras.layers.Dropout(0.2)(concat)
